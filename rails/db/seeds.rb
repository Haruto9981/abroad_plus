ActiveRecord::Base.transaction do
  ...
  User.create!(name: "Ryo_98_taa", email: "test6@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/6E633585-E231-45D0-92BF-83A0CC03E3DC_1_105_c.jpeg"),
               country: "USA", uni: "Kansas", bio: "Hello!")

  User.create!(name: "aya11922", email: "test7@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/0477E005-3F30-4EE5-A073-6582185CE9E7_4_5005_c.jpeg"),
               country: "Australia", uni: "Queensland", bio: "Hello!")

  User.create!(name: "TanabeKenn", email: "test8@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/EBF649F1-8FCF-46E9-9EEB-79D86D34FB8F_1_105_c.jpeg"),
               country: "Canada", uni: "Alberta", bio: "Hello!")

  User.create!(name: "haruto_aketa1234", email: "test9@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/6917C2F9-F127-411E-B180-5128956C03C2_1_105_c.jpeg"),
               country: "UK", uni: "Canterbury", bio: "Hello!")

  User.create!(name: "aya119222", email: "test10@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/0477E005-3F30-4EE5-A073-6582185CE9E7_4_5005_c.jpeg"),
               country: "Australia", uni: "Queensland", bio: "Hello!")

  User.create!(name: "Ryo_98_taaaa", email: "test11@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/6E633585-E231-45D0-92BF-83A0CC03E3DC_1_105_c.jpeg"),
               country: "USA", uni: "Kansas", bio: "Hello!")

  User.create!(name: "aya119211", email: "test12@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/0477E005-3F30-4EE5-A073-6582185CE9E7_4_5005_c.jpeg"),
               country: "Australia", uni: "Queensland", bio: "Hello!")

  User.create!(name: "TanabeKento", email: "test13@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/EBF649F1-8FCF-46E9-9EEB-79D86D34FB8F_1_105_c.jpeg"),
               country: "Canada", uni: "Alberta", bio: "Hello!")

  User.create!(name: "haruto_aketa12321", email: "test14@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/6917C2F9-F127-411E-B180-5128956C03C2_1_105_c.jpeg"),
               country: "UK", uni: "Canterbury", bio: "Hello!")

  User.create!(name: "Ryo_98_tako", email: "test15@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/6E633585-E231-45D0-92BF-83A0CC03E3DC_1_105_c.jpeg"),
               country: "USA", uni: "Kansas", bio: "Hello!")

  User.create!(name: "aya1185", email: "test16@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/0477E005-3F30-4EE5-A073-6582185CE9E7_4_5005_c.jpeg"),
               country: "Australia", uni: "Queensland", bio: "Hello!")

  User.create!(name: "Tanabe_ken", email: "test17@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/EBF649F1-8FCF-46E9-9EEB-79D86D34FB8F_1_105_c.jpeg"),
               country: "Canada", uni: "Alberta", bio: "Hello!")

  User.create!(name: "haruto_aketa321", email: "test18@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/6917C2F9-F127-411E-B180-5128956C03C2_1_105_c.jpeg"),
               country: "UK", uni: "Canterbury", bio: "Hello!")

  User.create!(name: "aya11", email: "test19@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/0477E005-3F30-4EE5-A073-6582185CE9E7_4_5005_c.jpeg"),
               country: "Australia", uni: "Queensland", bio: "Hello!")

  User.create!(name: "aya92", email: "test20@example.com", password: "password", confirmed_at: Time.current,
               image: File.open("./public/images/0477E005-3F30-4EE5-A073-6582185CE9E7_4_5005_c.jpeg"),
               country: "Australia", uni: "Queensland", bio: "Hello!")
