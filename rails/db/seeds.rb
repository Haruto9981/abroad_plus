ActiveRecord::Base.transaction do
  user1 = User.create!(name: "Megumi", email: "test1@example.com", password: "password", confirmed_at: Time.current,
  ...
  user2 = User.create!(name: "Ryo", email: "test2@example.com", password: "password", confirmed_at: Time.current,
                       image: File.open("./public/images/6E633585-E231-45D0-92BF-83A0CC03E3DC_1_105_c.jpeg"),
                       country: "USA", uni: "Kansas", bio: "Hello!")

  user3 = User.create!(name: "Aya", email: "test3@example.com", password: "password", confirmed_at: Time.current,
  ...
  user5 = User.create!(name: "HarutoAketa", email: "test5@example.com", password: "password", confirmed_at: Time.current,
