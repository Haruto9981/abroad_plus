  ...
  describe "GET api/v1/current/user" do
    ...
    context "ヘッダー情報が正常に送られた時" do
      it "正常にレコードを取得できる" do
        ...
        expect(res.keys).to eq ["id", "name", "first_name", "last_name", "email", "country", "uni", "start_date", "end_date",
                                "bio", "image", "total_likes_count", "total_diaries_count", "diaries", "following", "followers"]
